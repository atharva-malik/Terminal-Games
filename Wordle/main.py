...
def print_word(guess, answer):
    answer_List = list(answer)
    guess_List = list(guess)
    final_List = []
    for i in range(5):
        if guess_List[i] == answer_List[i]:
            final_List.append(green(guess_List[i], "bold"))
            final_List.append(" ")
        elif guess_List[i] in answer_List:
            final_List.append(yellow(guess_List[i], "bold"))
            final_List.append(" ")
        else:
            final_List.append(guess_List[i])
            final_List.append(" ")
